...
On the other hand there are technosignatures. ``Tecnhnosignature'' was first coined by Jill Tarter in the early 2000s and is loosely defined as a sign of technology that is not a biosignature \citep{wright_recommendations_2018}. Over the years there has been a lot of discussion on a formal definition of what a technosignature is, especially when it comes to deciding what can be considered ``technology''. Deliberation on this topic is complex and requires much care. For the purposes of this work the following definition proposed by \cite{Sheikh2021} is used when discussing technosignatures. This particular definition was created with the aim to provide interdisciplinary wording that could be broadly used. 
...
Over the past decade there has been a larger amount of technosignature research being outputted. This is in large part due to the Breakthrough Listen (BL) programme. BL is \$100 million dollar initiative. 
