...
\begin{figure}
    \centering
    \includegraphics[width = 0.8\textwidth]{chapter5/figures/narrowband-fraction.pdf}
    \caption[The fraction of stars that produce narrow-band emission ($f^n_c$)]{The fraction of stars that produce narrow-band emission ($f^n_c$) against the transmitter power of the total target pool. The hashed region (red) shows the constraints this survey places on a value of $f^n_c$ at 110 - 190 MHz.}
