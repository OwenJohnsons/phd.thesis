...
\begin{figure}
    ...
    \caption[LOFAR beam pointing on TESS target]{This figure illustrates one of the boresight pointings directed at a \textit{TESS} object (highlighted in green), with the LOFAR beam's Full-Width Half-Maximum (FWHM) shown in pink. The background image is from the Sloan Digital Sky Survey \citep[SDSS;]{SDSSDR13}.}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.45\textwidth]{chapter5/figures/EIRP_plots/off-beam-sensitivity-plots.pdf}
