...
The Crab Pulsar (PSR~B0531$+$21) is one of the most notable and well-studied pulsars, owing to its well-determined, relatively young age and its exceptional brightness. Embedded at the centre of the Crab Nebula, the pulsar is the remnant of the historical supernova of 1054 CE with radio emission was first being noted in 1968~\citep{sr68}. The pulsar provides a unique opportunity to investigate both the physics of neutron stars and the dynamics of supernova remnants. The Crab emits strongly across the entire electromagnetic spectrum, making it an invaluable tool for studying the interaction between a pulsar and its surrounding nebula \citep{hester_crab_2008}. \\ 
